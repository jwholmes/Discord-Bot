...
module.exports = {
  ...
  execute(message, args) {
    ...
    // var randomMCQ = biology.facts[randomNumber];
    var randomMCQ = biology[randomNumber];
    var MCQ = randomMCQ;
    // console.log(MCQ);
    var correctAnswer = MCQ.content.correctAnswer;
    var wrongAnswers = MCQ.content.wrongAnswers;
    var answers = `[${correctAnswer},${wrongAnswers}]`;
    var randomAnswerNumber1 = Math.floor(Math.random() * answers.length);
    var randomAnswer1 = answers[randomAnswerNumber1];

    // console.log(correctAnswer);
    // console.log(wrongAnswers);
    console.log(answers);
    console.log(randomAnswerNumber1);
    console.log(randomAnswer1);


    /* Insert getDescription function */
